...
VALUES
(
  SEQ_BOOK.NEXTVAL, '아이Q 정전', 'William Green', 23000
, TO_DATE(920713, 'RRMMDD'), 7, 21
, '문학노트', 2, 2
);
...
VALUES
(
  SEQ_BOOK.NEXTVAL, '어른 왕자', '이지훈', 16000
, TO_DATE('030213', 'RRMMDD'), 3, 17
, '비육일이', 1, 4
);
...
VALUES
(
  SEQ_BOOK.NEXTVAL, '사랑에 연습이 있었다면', '윤종선', 11000
, TO_DATE('210812', 'RRMMDD'), 11, 10
, '이룸이', 2, 4
);
...
VALUES
(
  SEQ_BOOK.NEXTVAL, '방황의 끝에서', '이다영', 31000
, TO_DATE('190617', 'RRMMDD'), 2, 27
, '오성출판사', 1, 2
);
...
VALUES
(
  SEQ_BOOK.NEXTVAL, '좋은 코드 있으면 소개시켜줘', '장준혁', 33000
, TO_DATE('190617', 'RRMMDD'), 13, 25
, '덤불피쉬', 2, 7
);
...
VALUES
(
  SEQ_BOOK.NEXTVAL, '야 너두 될 수 있어', '박상현', 18000
, TO_DATE('011112', 'RRMMDD'), 8, 9
, '도토리나무', 2, 5
);
...
(
  MEM_NO, MEM_NAME, MEM_PHONE
, MEM_ADDRESS, MEM_ID
, MEM_PWD, MEM_GRADE_NO, MEM_SUM_MONEY
